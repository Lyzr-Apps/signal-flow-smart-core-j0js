...
export const SEEDED_SIGNALS: SeededSignal[] = [
  {
    ...
    metrics: {
      ...
      sources: [
        { name: 'Nielsen IQ US Mass Skincare Q1 2026', type: 'Ecommerce / Retailer Data', claim: 'CeraVe share dropped from 18.2% to 14.8% in US mass moisturizer', verified: true, url: 'https://nielseniq.com/global/en/insights/analysis/2026/us-mass-skincare-market-review/' },
        { name: 'Walmart Shelf Audit March 2026', type: 'Ecommerce / Retailer Data', claim: 'Cetaphil gained endcap placement at Walmart, CVS, Walgreens', verified: true, url: 'https://retailwire.com/discussion/walmart-shelf-reset-skincare-2026/' },
        { name: 'Galderma Investor Presentation 2026', type: 'Competitor Filings', claim: '$40M US dermatologist endorsement campaign for Cetaphil', verified: true, url: 'https://www.galderma.com/investors/presentations' },
        { name: 'TikTok Brand Mention Tracking', type: 'Social / Creator Content', claim: 'CeraVe TikTok-driven growth has plateaued since mid-2025', verified: true, url: 'https://ads.tiktok.com/business/creativecenter/inspiration/popular/hashtag/pc/en' },
      ],
    },
  },
  {
    ...
    metrics: {
      ...
      sources: [
        { name: 'Circana US Mass Cosmetics Q1 2026', type: 'Ecommerce / Retailer Data', claim: 'Maybelline SuperStay foundation sales declined 15% YoY', verified: true, url: 'https://www.circana.com/intelligence/press-releases/2026/us-prestige-beauty-industry/' },
        { name: 'TikTok Analytics Dashboard', type: 'Social / Creator Content', claim: 'e.l.f. Halo Glow Liquid Filter generated 2.1B+ TikTok views in Q1 2026', verified: true, url: 'https://ads.tiktok.com/business/creativecenter/inspiration/popular/hashtag/pc/en' },
        { name: 'e.l.f. Beauty Q3 2025 Earnings Call', type: 'Competitor Filings', claim: 'Halo Glow Liquid Filter grew 185% YoY in US sales', verified: true, url: 'https://investor.elfbeauty.com/news-releases/news-release-details/elf-beauty-reports-q3-fiscal-2025-results' },
        { name: 'Target & Ulta Shelf Tracking', type: 'Ecommerce / Retailer Data', claim: 'e.l.f. SOV in US mass foundation grew from 8% to 14%', verified: true, url: 'https://retailwire.com/discussion/target-ulta-cosmetics-shelf-share-2026/' },
      ],
    },
  },
  {
    ...
    metrics: {
      ...
      sources: [
        { name: 'Target Planogram Shelf Audit Q1 2026', type: 'Ecommerce / Retailer Data', claim: 'Garnier lost 6 SKU facings; Native gained 4, Function of Beauty gained 5', verified: true, url: 'https://retailwire.com/discussion/target-hair-care-planogram-reset-2026/' },
        { name: 'Google Trends US Clean Beauty', type: 'Google Trends', claim: 'Clean beauty searches growing at 18% CAGR in US', verified: true, url: 'https://trends.google.com/trends/explore?geo=US&q=clean%20beauty' },
        { name: 'P&G 2026 Investor Day', type: 'Competitor Filings', claim: 'Native Hair Care reported 42% US growth', verified: true, url: 'https://pginvestor.com/financial-reporting/press-releases/news-details/2026/PG-Investor-Day-2026/' },
  ...
  },
  {
    ...
    metrics: {
      ...
      sources: [
        { name: 'Circana US OTC Acne Market Q1 2026', type: 'Ecommerce / Retailer Data', claim: 'Differin holds 31% US acne treatment share; Effaclar growth at 3% vs 11% category', verified: true, url: 'https://www.circana.com/intelligence/press-releases/2026/us-otc-skincare-acne/' },
        { name: 'Galderma 2025 Annual Report', type: 'Competitor Filings', claim: 'Differin OTC US revenue grew 24% YoY', verified: true, url: 'https://www.galderma.com/investors/annual-reports' },
        { name: 'Ulta Beauty Product Analytics', type: 'Ecommerce / Retailer Data', claim: 'Effaclar Duo conversion dropped 2.1pp at Ulta.com', verified: true, url: 'https://www.ulta.com/brand/la-roche-posay' },
      ],
    },
  },
  {
    ...
    metrics: {
      ...
      sources: [
        { name: 'Circana US Mass Lip Category Q1 2026', type: 'Ecommerce / Retailer Data', claim: 'NYX lip sales declined 18% YoY; lip oil segment grew 92%', verified: true, url: 'https://www.circana.com/intelligence/press-releases/2026/us-mass-lip-category/' },
        { name: 'TikTok #rarebeautylips Analytics', type: 'Social / Creator Content', claim: 'Rare Beauty lip content generated 1.8B views in Q1 2026', verified: true, url: 'https://ads.tiktok.com/business/creativecenter/inspiration/popular/hashtag/pc/en' },
        { name: 'Sephora US Sales Data Q1 2026', type: 'Ecommerce / Retailer Data', claim: 'Rare Beauty Soft Pinch products grew 145% YoY at Sephora US', verified: true, url: 'https://www.sephora.com/brand/rare-beauty' },
      ],
    },
  },
  {
    ...
    metrics: {
      ...
      sources: [
        { name: 'Circana US Prestige Skincare Q1 2026', type: 'Ecommerce / Retailer Data', claim: 'Kiehl\'s grew 2% vs 9% category; Ultra Facial Cream declined 6% at Sephora', verified: true, url: 'https://www.circana.com/intelligence/press-releases/2026/us-prestige-skincare-market/' },
        { name: 'Sephora US Digital Analytics', type: 'Ecommerce / Retailer Data', claim: 'Kiehl\'s conversion 2.8% vs 4.5% category average; Drunk Elephant at 5.2%', verified: true, url: 'https://www.sephora.com/brand/kiehls' },
        { name: 'Drunk Elephant Brand Performance Report', type: 'Competitor Filings', claim: 'Protini Polypeptide Cream grew 28% YoY at Sephora US', verified: true, url: 'https://www.shiseido.com/investors/en/ir-library/' },
      ],
    },
  },
  {
    ...
    metrics: {
      ...
      sources: [
        { name: 'Circana US Prestige Foundation Q1 2026', type: 'Ecommerce / Retailer Data', claim: 'Lancome Teint Idole declined 14% YoY; share dropped from 12.5% to 9.8%', verified: true, url: 'https://www.circana.com/intelligence/press-releases/2026/us-prestige-color-cosmetics/' },
        { name: 'Sephora US Search & Discovery Data', type: 'Ecommerce / Retailer Data', claim: 'Lancome foundation search rank dropped from #3 to #7 at Sephora', verified: true, url: 'https://www.sephora.com/brand/lancome' },
        { name: 'Fenty Beauty Brand Tracker Q1 2026', type: 'Competitor Filings', claim: 'Pro Filt\'r grew 18% YoY with 50-shade range driving inclusivity perception', verified: true, url: 'https://www.lvmh.com/investors/reports-and-publications/' },
      ],
    },
  },
  {
    ...
    metrics: {
      ...
      sources: [
        { name: 'Circana US Derm-Recommended Skincare Q1 2026', type: 'Ecommerce / Retailer Data', claim: 'Vichy US sales declined 5% YoY; Mineral 89 down 8%', verified: true, url: 'https://www.circana.com/intelligence/press-releases/2026/us-dermatologist-skincare/' },
        { name: 'CVS Health Category Review 2026', type: 'Ecommerce / Retailer Data', claim: 'Clinique Moisture Surge gaining pharmacy shelf space; Vichy facings flat', verified: true, url: 'https://www.cvs.com/shop/skin-care/brand/vichy' },
        { name: 'US Consumer Brand Awareness Tracker Q1 2026', type: 'Real-time Web Research', claim: 'Vichy awareness at 22% vs La Roche-Posay at 58% among US consumers under 40', verified: true, url: 'https://www.kantar.com/campaigns/brandz' },
      ],
    },
  },
  {
    ...
    metrics: {
      ...
      sources: [
        { name: 'Circana US Premium Hair Care Q1 2026', type: 'Ecommerce / Retailer Data', claim: 'Kerastase US sales declined 7% YoY; salon channel share down from 38% to 29%', verified: true, url: 'https://www.circana.com/intelligence/press-releases/2026/us-premium-hair-care/' },
        { name: 'Olaplex 2025 10-K Filing', type: 'Competitor Filings', claim: 'Olaplex holds 22% US premium hair treatment share; DTC at 35% of revenue', verified: true, url: 'https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001868726&type=10-K' },
        { name: 'Sephora US Hair Care Category Review', type: 'Ecommerce / Retailer Data', claim: 'Moroccanoil grew 18% and K18 grew 48% at Sephora US', verified: true, url: 'https://www.sephora.com/shop/premium-hair-care' },
      ],
    },
  },
  {
    ...
    metrics: {
      ...
      sources: [
        { name: 'Circana US CC/Tinted Moisturizer Q1 2026', type: 'Ecommerce / Retailer Data', claim: 'IT CC+ Cream declined 16% YoY; bareMinerals Complexion Rescue grew 22%', verified: true, url: 'https://www.circana.com/intelligence/press-releases/2026/us-complexion-category/' },
        { name: 'Sephora & Ulta Consumer Demographics', type: 'Ecommerce / Retailer Data', claim: 'IT Cosmetics median buyer age shifted from 38 to 44 over 2 years', verified: true, url: 'https://www.ulta.com/brand/it-cosmetics' },
        { name: 'ILIA Beauty Growth Report', type: 'Competitor Filings', claim: 'ILIA Super Serum Skin Tint grew 35% YoY with 30-shade clean prestige positioning', verified: true, url: 'https://iliabeauty.com/pages/about' },
      ],
    },
  },
]
...
export const SEEDED_OPPORTUNITIES: SeededOpportunity[] = [
  {
    ...
    metrics: {
      ...
      sources: [
        { name: 'Google Trends US Peptide Searches', type: 'Google Trends', claim: 'Peptide serum and peptide moisturizer US search volume up 180% YoY', verified: true, url: 'https://trends.google.com/trends/explore?geo=US&q=peptide%20serum' },
        { name: 'TikTok #peptideskincare', type: 'Social / Creator Content', claim: '1.2B views on peptide skincare content', verified: true, url: 'https://ads.tiktok.com/business/creativecenter/inspiration/popular/hashtag/pc/en' },
        { name: 'Circana US Skincare Category Data', type: 'Ecommerce / Retailer Data', claim: 'The Ordinary Buffet achieved 340% sales growth', verified: true, url: 'https://www.circana.com/intelligence/press-releases/2026/us-skincare-category-review/' },
        { name: 'The Ordinary Q4 2025 Earnings', type: 'Competitor Filings', claim: 'The Ordinary Buffet dominates US peptide skincare category', verified: true, url: 'https://www.deciem.com/en-us/theordinary/investor-relations' },
      ],
    },
  ...
  },
  {
    ...
    metrics: {
      ...
      sources: [
        { name: 'NPD US Prestige Men\'s Beauty 2025', type: 'Ecommerce / Retailer Data', claim: 'US men\'s prestige skincare grew 22% YoY to $1.1B', verified: true, url: 'https://www.circana.com/intelligence/press-releases/2025/us-prestige-mens-beauty/' },
        { name: 'TikTok #mensskincare Analytics', type: 'Social / Creator Content', claim: '#mensskincare reached 890M TikTok views', verified: true, url: 'https://ads.tiktok.com/business/creativecenter/inspiration/popular/hashtag/pc/en' },
        { name: 'Target Buyer Feedback', type: 'Ecommerce / Retailer Data', claim: 'L\'Oreal Men Expert has limited US retail distribution', verified: false, url: 'https://www.target.com/c/men-s-skin-care/-/N-5xu0b' },
      ],
    },
  ...
  },
  {
    ...
    metrics: {
      ...
      sources: [
        { name: 'Circana US Body Care Q4 2025', type: 'Ecommerce / Retailer Data', claim: 'US premium body care ($12+) grew 35% YoY', verified: true, url: 'https://www.circana.com/intelligence/press-releases/2025/us-body-care-market-review/' },
        { name: 'TikTok #bodyskincare Analytics', type: 'Social / Creator Content', claim: '#bodyskincare reached 2.4B views on TikTok', verified: true, url: 'https://ads.tiktok.com/business/creativecenter/inspiration/popular/hashtag/pc/en' },
        { name: 'Unilever 2025 Annual Earnings', type: 'Competitor Filings', claim: 'Necessaire grew 52% in US prestige body care', verified: true, url: 'https://www.unilever.com/investor-relations/annual-report-and-accounts/' },
      ],
    },
    signalType: 'Consumer Sentiment Shift',
    category: 'Skincare',
  ...
  },
  {
    ...
    metrics: {
      ...
      sources: [
        { name: 'FDA GRASE Proposed Rule Update', type: 'Real-time Web Research', claim: 'FDA released updated study data on chemical sunscreen absorption', verified: true, url: 'https://www.fda.gov/drugs/understanding-over-counter-medicines/sunscreen' },
        { name: 'Google Trends US Mineral Sunscreen', type: 'Google Trends', claim: 'Mineral sunscreen US searches grew 140% YoY', verified: true, url: 'https://trends.google.com/trends/explore?geo=US&q=mineral%20sunscreen' },
        { name: 'Circana US Sun Care Q1 2026', type: 'Ecommerce / Retailer Data', claim: 'EltaMD grew 32%, Supergoop! mineral collection grew 45%', verified: true, url: 'https://www.circana.com/intelligence/press-releases/2026/us-sun-care-market/' },
      ],
    },
    signalType: 'Consumer Sentiment Shift',
    category: 'Skincare',
  ...
  },
  {
    ...
    metrics: {
      ...
      sources: [
        { name: 'Circana US Mass Cosmetics Gen Z Report Q1 2026', type: 'Ecommerce / Retailer Data', claim: 'Clean/vegan mass makeup growing 32% YoY; NYX Gen Z share dropped from 14% to 11%', verified: true, url: 'https://www.circana.com/intelligence/press-releases/2026/us-gen-z-beauty-market/' },
        { name: 'e.l.f. Beauty Vegan Certification', type: 'Competitor Filings', claim: 'e.l.f. fully vegan-certified brand gaining preference among Gen Z', verified: true, url: 'https://investor.elfbeauty.com/esg' },
        { name: 'PETA Cruelty-Free Database', type: 'Real-time Web Research', claim: '67% of Gen Z consider vegan certification important in makeup purchase', verified: true, url: 'https://www.peta.org/living/personal-care-fashion/beauty-without-bunnies/' },
      ],
    },
    signalType: 'Consumer Sentiment Shift',
    category: 'Color Cosmetics',
  ...
  },
  {
    ...
    metrics: {
      ...
      sources: [
        { name: 'Circana US Prestige Fragrance Q1 2026', type: 'Ecommerce / Retailer Data', claim: 'US prestige fragrance grew 18% to $6.8B; Lancome grew 8%', verified: true, url: 'https://www.circana.com/intelligence/press-releases/2026/us-prestige-fragrance-market/' },
        { name: 'Sephora US Fragrance Category Data', type: 'Ecommerce / Retailer Data', claim: 'Discovery sets generate 3x conversion; niche fragrance growing 35%', verified: true, url: 'https://www.sephora.com/shop/perfume' },
        { name: 'LVMH 2025 Annual Report', type: 'Competitor Filings', claim: 'Dior Sauvage franchise grew 22% YoY with 6 flanker variants', verified: true, url: 'https://www.lvmh.com/investors/reports-and-publications/' },
      ],
    },
    signalType: 'Consumer Sentiment Shift',
    category: 'Fragrance',
  ...
  },
  {
    ...
    metrics: {
      ...
      sources: [
        { name: 'Circana US Scalp Care Category Q1 2026', type: 'Ecommerce / Retailer Data', claim: 'US scalp care grew 45% YoY to $420M', verified: true, url: 'https://www.circana.com/intelligence/press-releases/2026/us-scalp-care-market/' },
        { name: 'Sephora US Hair Care Scalp Category', type: 'Ecommerce / Retailer Data', claim: 'Briogeo Scalp Revival grew 52% YoY; scalp serums fastest-growing subcategory', verified: true, url: 'https://www.sephora.com/shop/scalp-care' },
        { name: 'Google Trends US Scalp Care', type: 'Google Trends', claim: 'Scalp care and scalp serum searches grew 120% YoY in US', verified: true, url: 'https://trends.google.com/trends/explore?geo=US&q=scalp%20care' },
      ],
    },
    signalType: 'Ingredient Trend Surge',
    category: 'Hair Care',
...
export const SEEDED_RISKS: SeededRisk[] = [
  {
    ...
    metrics: {
      ...
      sources: [
        { name: 'Circana US Anti-Aging Q1 2026', type: 'Ecommerce / Retailer Data', claim: 'Revitalift US sales declined 11% YoY; SOV dropped from 19% to 15%', verified: true, url: 'https://www.circana.com/intelligence/press-releases/2026/us-anti-aging-skincare-market/' },
        { name: 'P&G 2025 10-K Filing', type: 'Competitor Filings', claim: 'Olay Regenerist grew 14% YoY in US market', verified: true, url: 'https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0000080424&type=10-K' },
        { name: 'Kantar US Media Spend Estimates', type: 'Real-time Web Research', claim: 'Olay outspending Revitalift by $25M in US advertising', verified: false, url: 'https://www.kantar.com/campaigns/media-reactions' },
      ],
    },
    signalType: 'Competitor Launch/Relaunch',
    category: 'Skincare',
  ...
  },
  {
    ...
    metrics: {
      ...
      sources: [
        { name: 'Ulta Product Page Analytics', type: 'Ecommerce / Retailer Data', claim: 'Elvive Bond Repair conversion at 2.4% vs 5.1% category benchmark', verified: true, url: 'https://www.ulta.com/brand/loreal-paris-elvive' },
        { name: 'Target eCommerce Conversion Data', type: 'Ecommerce / Retailer Data', claim: 'Elvive 2.1% conversion vs 4.6% benchmark at Target', verified: true, url: 'https://www.target.com/b/l-oreal-paris-elvive/-/N-q643lef9hvi' },
        { name: 'Olaplex 2025 10-K Filing', type: 'Competitor Filings', claim: 'Olaplex holds 48% US bond repair market share', verified: true, url: 'https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001868726&type=10-K' },
        { name: 'Ulta & Target Consumer Reviews', type: 'Product Reviews', claim: '189 reviews, 3.4/5 average; consumer confusion vs Olaplex', verified: true, url: 'https://www.ulta.com/brand/loreal-paris-elvive?N=1z12lx1Z1z12uzp' },
      ],
    },
...
export const SEEDED_ALERTS: SeededAlert[] = [
  {
    ...
    metrics: {
      ...
      sources: [
        ...
        { name: 'Congressional PFAS-Free Cosmetics Act S.4524', type: 'Real-time Web Research', claim: 'Federal PFAS-free legislation advancing in US Senate', verified: true, url: 'https://www.congress.gov/bill/118th-congress/senate-bill/4524' },
        { name: 'e.l.f. 2025 Investor Day', type: 'Competitor Filings', claim: 'e.l.f. PFAS-free certified across full US product line', verified: true, url: 'https://investor.elfbeauty.com/news-releases/news-release-details/elf-beauty-investor-day-2025' },
        { name: 'Google Trends US PFAS Cosmetics', type: 'Google Trends', claim: 'PFAS-free makeup searches grew 420% YoY in US', verified: true, url: 'https://trends.google.com/trends/explore?geo=US&q=PFAS%20free%20makeup' },
      ],
    },
  ...
  },
  {
    ...
    metrics: {
      ...
      sources: [
        { name: 'FDA GRASE Proposed Rule Update', type: 'Real-time Web Research', claim: 'FDA released updated study data on chemical sunscreen absorption', verified: true, url: 'https://www.fda.gov/drugs/understanding-over-counter-medicines/sunscreen' },
        { name: 'Google Trends US Mineral Sunscreen', type: 'Google Trends', claim: 'Mineral sunscreen US searches grew 140% YoY', verified: true, url: 'https://trends.google.com/trends/explore?geo=US&q=mineral%20sunscreen' },
        { name: 'Retailer Sales Reports (EltaMD, Supergoop!)', type: 'Ecommerce / Retailer Data', claim: 'EltaMD grew 32%, Supergoop! mineral collection grew 45%', verified: false, url: 'https://www.circana.com/intelligence/press-releases/2026/us-sun-care-market/' },
  ...
  },
  {
    ...
    metrics: {
      ...
      sources: [
        { name: 'US Prestige Retail Channel Shift Report 2026', type: 'Ecommerce / Retailer Data', claim: 'Sephora +22% YoY, standalone brand stores -15% YoY in US prestige', verified: true, url: 'https://www.circana.com/intelligence/press-releases/2026/us-prestige-retail-channels/' },
        { name: 'Kiehl\'s US Store Performance Data', type: 'Ecommerce / Retailer Data', claim: 'Kiehl\'s standalone store foot traffic declined 18% YoY', verified: true, url: 'https://www.kiehls.com/stores' },
        { name: 'Shiseido 2025 Annual Report', type: 'Competitor Filings', claim: 'Drunk Elephant DTC+Sephora model outperforming standalone retail brands', verified: true, url: 'https://www.shiseido.com/investors/en/ir-library/' },
      ],
    },
    signalType: 'Stockout / Shelf Loss',
    category: 'Skincare',
  ...
  },
  {
    ...
    metrics: {
      ...
      sources: [
        { name: 'CVS Health Skincare Category Review Q1 2026', type: 'Ecommerce / Retailer Data', claim: 'Pharmacy skincare channel declined 6% YoY; foot traffic down 12%', verified: true, url: 'https://www.cvs.com/shop/skin-care' },
        { name: 'US Retail Channel Shift Report 2026', type: 'Real-time Web Research', claim: 'Clinique entering CVS; Drunk Elephant minis at Walgreens', verified: true, url: 'https://retailwire.com/discussion/prestige-brands-pharmacy-distribution-2026/' },
        { name: 'Amazon US Premium Beauty Growth Report', type: 'Ecommerce / Retailer Data', claim: 'Amazon Premium Beauty grew 28% YoY in US skincare', verified: true, url: 'https://www.aboutamazon.com/news/retail/amazon-premium-beauty' },
      ],
    },
    signalType: 'Competitor Launch/Relaunch',
    category: 'Skincare',
  ...
  },
  {
    ...
    metrics: {
      ...
      sources: [
        { name: 'US Beauty Consumer Demographic Report Q1 2026', type: 'Real-time Web Research', claim: 'IT Cosmetics median buyer age shifted from 38 to 44; under-35 share dropped to 4.8%', verified: true, url: 'https://www.circana.com/intelligence/press-releases/2026/us-beauty-consumer-demographics/' },
        { name: 'IT Cosmetics Brand Health Tracker', type: 'Ecommerce / Retailer Data', claim: 'Brand search volume declined 22% YoY; social engagement down 35%', verified: true, url: 'https://www.ulta.com/brand/it-cosmetics' },
        { name: 'bareMinerals Brand Repositioning Case Study', type: 'Competitor Filings', claim: 'bareMinerals successfully lowered median buyer age from 42 to 36 with clean mineral messaging', verified: true, url: 'https://orveon.com/our-brands/bareminerals/' },
      ],
    },
    signalType: 'Consumer Sentiment Shift',
    category: 'Color Cosmetics',
